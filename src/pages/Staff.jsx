...
export default function Staff() {
  ...
  async function deleteEmployee(id) {
    ...
    await logActivity('delete', 'employee', emp?.name)
    load()
  }
  async function deleteShift(id) {
    ...
    await logActivity('delete', 'shift', emp?.name)
    load()
  }
...
function EmployeeFormModal({ stores, onClose, onSaved }) {
  ...
  async function save() {
    ...
    await logActivity('create', 'employee', form.name)
    onSaved()
  }
  return (
...
function ShiftFormModal({ stores, selectedStoreId, onClose, onSaved }) {
  ...
  async function save() {
    ...
    const empName = empOptions.find(e => e.id === form.employee_id)?.name
    await logActivity('create', 'shift', empName, `${form.type} — ${form.date}`)
    onSaved()
  }
